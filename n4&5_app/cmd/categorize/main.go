...
func main() {
	...
	for {
		// Fetch next batch
		// Seed uses "Daily Life" / "Work"; only "Daily Life" is unambiguously a placeholder (Work is also a valid pillar).
		rows, err := db.Query(`
				...
				Messages: []openai.ChatCompletionMessage{
					{
						...
						Content: `You are a Japanese Linguistics Expert. Categorize N4/N5 words.
